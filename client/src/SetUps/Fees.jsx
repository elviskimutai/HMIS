...
class Fees extends Component {
  ...
  fetchFeess = () => {
    fetch("/api/Fees/" + localStorage.getItem("CompanyID"), {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        "x-access-token": localStorage.getItem("xtoken")
  ...
  handleSubmit = event => {
    ...
    if (this.state.isUpdate) {
      this.UpdateData("/api/Fees/" + this.state.ID, data);
    } else {
      this.postData("/api/Fees", data);
    }
  };
  handleEdit = Fees => {
    const data = {
    ...
    // this.handleRolesOpoup(Fees.Amount);
  };
  handleDelete = k => {
    swal({
                    ...
                    >
                      <div className=" row">
                        <div className="col-sm">
                          ...
                          <div className="col-sm">
                          <div className="form-group">
                          <label for="Amount" className="fontWeight-bold">
                          Amount{" "}
                          </label>
                          <input
                              type="text"
